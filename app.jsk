...
const MODEL_CONFIGS = [
    ...
    {
        id: 'the-architect',
        name: '3. The Architect (System Planner)',
        prompt: `
    ...
    {
        id: 'story-weaver',
        name: '4. The Story Weaver (Creative Writer)',
        prompt: `
    ...
    {
        id: 'gemini-scientist',
        name: '5. Gemini Scientist (Deep Analysis)',
        prompt: `
    ...
    {
        id: 'the-debugger',
        name: '6. The Debugger (Code Optimiser)',
        prompt: `
    ...
    {
        id: 'google-ai-pro',
        name: '7. Google AI Pro (Integration Expert)',
        prompt: `
